...
const navItems = [
  { icon: LayoutDashboard, label: 'Queue', id: 'queue' },
  ...
  return (
    <aside className="w-72 h-screen bg-white border-r border-slate-200 flex flex-col shrink-0">
      ...
      <div className="p-6 border-t border-slate-100">
        <button className="w-full flex items-center gap-4 px-4 py-3 rounded-2xl text-sm font-bold text-slate-400 hover:bg-red-50 hover:text-red-600 transition-all duration-300">
          <LogOut size={20} />
          Sign Out
        </button>
      </div>
